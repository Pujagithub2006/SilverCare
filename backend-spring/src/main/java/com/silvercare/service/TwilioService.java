...
public class TwilioService {
    ...
    @Value("${twilio.account.sid:ACac18cc74bcf1b1190b4f12209bfab258}")
    private String accountSid;

    @Value("${twilio.auth.token:e827f5e89c1fe9f2144af636c2da5c35}")
    private String authToken;

    @Value("${twilio.phone.number:+15707084443}")
